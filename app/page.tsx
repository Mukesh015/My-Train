    ...
    <>
      <div className="font-Montserrat h-screen w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
        ...
        <div className="max-w-2xl mx-auto p-4">
          ...
          <div className="relative group mt-6 ml-32">
            <div
            ...
            >
              ...
              >
                ...
                >
                  Get Started
                  <svg className="ml-1" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#e8eaed"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M22 12l-4-4v3H3v2h15v3l4-4z" /></svg>
                </button>
