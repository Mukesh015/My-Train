...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        if (trainPageElement && homePageElement && flightPageElement) {
            if (url.includes("/train")) {
                if (trainPageElement) {
                    trainPageElement.style.color = '#f43f5e';
                    homePageElement.style.color = '#ffffff';
                    flightPageElement.style.color = '#ffffff';
                }
            }
                ...
                if (flightPageElement) {
                    ...
                    homePageElement.style.color = '#ffffff';
                    trainPageElement.style.color = '#ffffff';
                }
            }
